...
def write_ads_levas_report():
  ...
  try:
    ...
    for item in dev_active_offers_info:
      ...
      active_offer_folder_id = item["folder_id"]
        ...
        for ad in ads_levas_list:
          ...
          if (ad[6] == "⚙️ Testando" or ad[6] == "⏱️ Em validação") and ad[1] in ads_group:
            ...
            with open(filename, "a", encoding="utf-8") as file:
              ...
              file.write(f"HOOK UTMify: {new_hook_rate} - HOOK Ads: {ads_levas_current_hook} - Total: {total_hook}\n")
              file.write(f"CTR UTMify: {new_ctr} - CTR Ads: {ads_levas_current_ctr} - Total: {total_ctr}\n")
