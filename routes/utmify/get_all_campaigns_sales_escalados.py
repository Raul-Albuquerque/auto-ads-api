...
@router.get("/utmify/campaigns/escalados/sales/{day}")
def get_all_campaigns_sales(day:str):
  name_contains = None

  try:
    response = get_campaigns(day=day, name_contains=name_contains, products=front_products_list, level="campaign")
    ...
    worksheet_index = search_worksheet_index("DB_3.0", "1kYakvWtJ-2G1Vu-ylxb4qYCzSoozMunz", "RAW-CAMPAIGNS-ESCALADOS-SALES")
