...
from .get_all_campaigns_escalados import router as all_campaigns_escalados
from .get_all_campaigns_sales_escalados import router as all_campaigns_sales_escalados
...
utmify_router.include_router(all_campaigns_escalados)
utmify_router.include_router(all_campaigns_sales_escalados)