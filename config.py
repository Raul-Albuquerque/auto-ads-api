...
REPORT_WORKSHEETS = {
    ...
    "leads": "Modelo",
    "escalados": "MODELO",
    "traffic_control": "[Tráfego] Métricas /08",
}
...
SPREADSHEET_TRAFFIC_CONTROL_ID = os.getenv("SPREADSHEET_TRAFFIC_CONTROL_ID")
...
# SPREADSHEET_TRAFFIC_CONTROL_ID = os.getenv("DEV_SPREADSHEET_TRAFFIC_CONTROL_ID")
